...
def main():
    ...
    parser.add_argument("-bc","--back-colour", help="control background colour, accepts colour name in string format", default="black")
    parser.add_argument("-fc","--fill-colour", help="control fill colour, accepts colour name in string format", default="white")
